                    ...
                    <li class="nav-item">
                        <a href="#profile" class="nav-link {{ $active_tab=="profile"? 'active':'' }}"
                           role="tab" data-toggle="tab">
                            @lang('corals-marketplace-pro::labels.auth.profile')
                        </a>
                    </li>
                    ...
                    <div class="tab-pane {{ $active_tab=="profile"? 'active':'' }}" id="profile" role="tabpanel">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="text-center">
                                                    ...
                                                    <small class="d-block">@lang('corals-marketplace-pro::labels.auth.click_pic_update')</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="notification_preferences">
                                        ...
                                        @empty
                                            <div class="alert alert-info"><h5
                                                        class="text-center">@lang('corals-marketplace-pro::labels.auth.no_notification')</h5>
                                            </div>
                                        @endforelse
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        {!! CoralsForm::formButtons(trans('corals-marketplace-pro::labels.auth.save',['title' => $title_singular]),[],['href'=>url('dashboard')]) !!}
                                    </div>
                                    {!! Form::close() !!}
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <strong>@lang('corals-marketplace-pro::labels.auth.change_image')</strong></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="actions my-3">
                        <span class="">
                            @lang('corals-marketplace-pro::labels.auth.browse_files')
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary m-r-10 m-l-10"
                            id="Save">@lang('corals-marketplace-pro::labels.auth.save',['title'=>''])</button>
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal">@lang('corals-marketplace-pro::labels.auth.close')</button>
                </div>
            </div>
        </div>
    </div>
