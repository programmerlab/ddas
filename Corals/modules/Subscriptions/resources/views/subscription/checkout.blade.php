                                            ...
                                            <table class="table color-table info-table table table-hover table-striped table-condensed">
                                                ...
                                                @if($plan)
                                                    <tr>
                                                        ...
                                                        <td class="vcenter"><b> <label
                                                                        class="label badge badge-info label-info">@lang('Subscriptions::labels.subscription.subscribe')</label>
                                                            </b>
                                                        </td>
                                                ...
                                                @if($current_plan)
                                                    <tr>
                                                        ...
                                                        <td class="vcenter"><b> <label
                                                                        class="label label-danger badge badge-danger">@lang('Corals::labels.confirmation.cancel')</label>
                                                            </b>
                                                        </td>
