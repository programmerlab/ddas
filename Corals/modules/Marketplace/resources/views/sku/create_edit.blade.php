    ...
    <script type="text/javascript">
        function setInventoryValue(value) {
            ...
            if (value == 'bucket') {
                ...
                input = '{{ CoralsForm::select('inventory_value','Marketplace::attributes.sku.inventory_value',config('marketplace.models.sku.bucket'),false,$sku->inventory_value?$sku->inventory_value:null )  }}';
