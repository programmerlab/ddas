...
return [
    ...
    'checkout' => [
        ...
        'redeem_points_exceed_balance' => 'You cannot redeem points more than your balance',
    ],
    'shipping' => [
        'invalid_store' => 'Invalid Store',
        'no_report_file' => 'Report file is either deleted or not available'
    ],
    'store' => [
        'invalid_store' => 'User has no Store attached to',
        'invalid_subscription_product' => 'Invalid Subscription Product'
    ],
];
